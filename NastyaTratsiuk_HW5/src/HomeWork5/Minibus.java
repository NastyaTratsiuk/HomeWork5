...
public class Minibus extends Car {
    ...
    public Minibus(String name, byte number, String color, boolean state, Brand copyBrand, String formatterDate,
                   int numberOfSeats, boolean availabilityOfSeats, boolean standingPlaces) {
        super(name, number, color, state, copyBrand, formatterDate);
